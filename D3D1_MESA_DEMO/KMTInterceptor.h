...
using PFN_D3DKMT_CREATECONTEXTVIRTUAL = NTSTATUS(WINAPI*)(D3DKMT_CREATECONTEXTVIRTUAL*);
...
using PFN_D3DKMT_UNLOCK2 = NTSTATUS (WINAPI*)(D3DKMT_UNLOCK2*);
...
using PFN_D3DKMT_EVICT = NTSTATUS(WINAPI*)(D3DKMT_EVICT*);
using PFN_D3DKMT_MAKERESIDENT = NTSTATUS(WINAPI*)(D3DDDI_MAKERESIDENT*);
using PFN_D3DKMT_CREATEPAGINGQUEUE = NTSTATUS(WINAPI*)(D3DKMT_CREATEPAGINGQUEUE*);

using PFN_D3DKMT_CREATESYNCHRONIZATIONOBJECT = NTSTATUS(WINAPI*)(D3DKMT_CREATESYNCHRONIZATIONOBJECT*);
using PFN_D3DKMT_CREATESYNCHRONIZATIONOBJECT2 = NTSTATUS(WINAPI*)(D3DKMT_CREATESYNCHRONIZATIONOBJECT2*);
using PFN_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU = NTSTATUS(WINAPI*)(D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU*);
using PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU = NTSTATUS(WINAPI*)(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU*);
using PFN_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU = NTSTATUS(WINAPI*)(D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU*);
using PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU = NTSTATUS(WINAPI*)(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU*);
using PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2 = NTSTATUS(WINAPI*)(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2*);
...
private:
    ...
    static NTSTATUS WINAPI Hooked_D3DKMTCreateContextVirtual(D3DKMT_CREATECONTEXTVIRTUAL* pData);
    ...
    static NTSTATUS WINAPI Hooked_D3DKMTUnlock2(D3DKMT_UNLOCK2* pData);
    ...
    static NTSTATUS WINAPI Hooked_D3DKMTMAKERESIDENT(D3DDDI_MAKERESIDENT* pData);
    static NTSTATUS WINAPI Hooked_D3DKMTEVICT(D3DKMT_EVICT* pData);
    static NTSTATUS WINAPI Hooked_D3DKMTCREATEPAGINGQUEUE(D3DKMT_CREATEPAGINGQUEUE* pData);

    static NTSTATUS WINAPI Hooked_D3DKMT_CREATESYNCHRONIZATIONOBJECT(D3DKMT_CREATESYNCHRONIZATIONOBJECT* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_CREATESYNCHRONIZATIONOBJECT2(D3DKMT_CREATESYNCHRONIZATIONOBJECT2* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU(D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU(D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU* pData);
    static NTSTATUS WINAPI Hooked_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2(D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2* pData);
    ...
    static PFN_D3DKMT_CREATECONTEXTVIRTUAL s_OriginalCreateContextVirtual;
    ...
    static PFN_D3DKMT_UNLOCK2 s_OriginalUnlock2;
    ...
    static PFN_D3DKMT_MAKERESIDENT s_OriginalMakeResident;
    static PFN_D3DKMT_EVICT s_OriginalEvict;
    static PFN_D3DKMT_CREATEPAGINGQUEUE s_OriginalCreatePagingQueue;

    static PFN_D3DKMT_CREATESYNCHRONIZATIONOBJECT s_OriginalCreateSysObj;
    static PFN_D3DKMT_CREATESYNCHRONIZATIONOBJECT2 s_OriginalCreateSysObj2;
    static PFN_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMCPU s_OriginalWaitSysObjCpu;
    static PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMCPU s_OriginalSignalSysObjCpu;
    static PFN_D3DKMT_WAITFORSYNCHRONIZATIONOBJECTFROMGPU s_OriginalWaitSysObGpu;
    static PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU s_OriginalSignalSysObjGpu;
    static PFN_D3DKMT_SIGNALSYNCHRONIZATIONOBJECTFROMGPU2 s_OriginalSignalSysObjGpu2;
};
